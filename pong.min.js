...
var Controller = function Controller(name, io) {
    ...
    this.up.addEventListener('mousedown', function (event) {
        io.emit(name, -1);
        console.log(-1);
    });

    this.up.addEventListener('mouseup', function (event) {
        io.emit(name, 0);
        console.log(0);
    });
    ...
    this.down.addEventListener('mousedown', function (event) {
        io.emit(name, 1);
        console.log(1);
    });

    this.down.addEventListener('mouseup', function (event) {
        io.emit(name, 0);
        console.log(0);
    });
...
var Socket = function Socket() {
    ...
    this.io = io('http://localhost:6001');
};
